...
List<List<Question>> questions = [
  ...
  [
    ...
    Question('7 * 2 = ?', ['10', '14', '5'], 14),
    Question('5 * 3 = ?', ['15', '12', '8'], 15),
    Question('9 * 4 = ?', ['18', '27', '36'], 36),
    Question('6 * 7 = ?', ['35', '42', '48'], 42),
    Question('2 * 9 = ?', ['18', '15', '12'], 18),
    Question('8 * 3 = ?', ['30', '16', '24'], 24),
    Question('10 * 5 = ?', ['40', '50', '30'], 50),
    Question('12 * 2 * 2 = ?', ['48', '36', '24'], 48),
    Question('3 * 8 * 1 = ?', ['14', '24', '36'], 36),
  ],
  [
